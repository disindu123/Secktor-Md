...
module.exports = {
  ...
  sessionName:  process.env.SESSION_ID === undefined ? 'DisinduDamsandu123456' : process.env.SESSION_ID,
  ...
  antibadword :  process.env.ANTI_BAD_WORD === undefined ? 'nbwoed,hutta,fuck' : process.env.ANTI_BAD_WORD,
